...
namespace EcommerceStore.Catalogo.API.Data.Repository
{
    public class ProdutoRepository : IProdutoRepository
    {
        ...
        public async Task<PagedResult<Produto>> ObterTodos(int pageSize, int pageIndex, string query = null)
        {
            ...
            //    .Take(pageSize)
            //    //.Where(produto => produto.Nome.Contains(query))
            //    .ToListAsync();
        ...
        public async Task<List<Produto>> ObterPordutosPorId(string ids)
        {
            ...
            return await _context.Produtos.AsNoTracking()
                .Where(prod => idsValue.Contains(prod.Id) && prod.Ativo).ToListAsync();
        }
