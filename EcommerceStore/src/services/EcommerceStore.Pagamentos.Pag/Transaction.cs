...
namespace EcommerceStore.Pagamentos.Pag
{
    public class Transaction
    {
        ...
        public string AcquirerResponseName { get; set; }
        ...
        public float? AntifraudeScore { get; set; }
        ...
        public bool? ShoudCapture { get; set; }
        ...
        public Transaction(PagarmeService pagarmeService)
        {
