...
namespace EcommerceStore.Pedidos.Infraestructure.Migrations
{
    public partial class PedidosVoucher : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    Codigo = table.Column<int>(nullable: false, defaultValueSql: "NEXT VALUE FOR SequenciaPedido"),
